...
// have to take, labeled from 0 to numCourses
// - 1. You are given an array prerequisites
// where prerequisites[i] = [ai, bi] indicates
// that you must take course bi first if you
...
// mark this node as fully processed (no cycle from here)  
        visited[node] = 2; 
        return false;
    }
